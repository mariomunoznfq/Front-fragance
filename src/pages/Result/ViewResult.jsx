...
const uniqueByName = (arr = []) =>
  arr.filter(
    (item, i, a) => i === a.findIndex((x) => x.NameProduct === item.NameProduct)
  );
...
function ViewResult({ userData = {}, onReset }) {
          ...
          <div style={{ textAlign: 'center', marginTop: 40, width: '100%' }}>
            ...
            >
              {selectedPerfume.Description ||
                'No hay descripción disponible para esta fragancia.'}
            </p>
          </div>
          ...
          <button
            ...
            onClick={() => {
              ...
              if (selectedPerfume.ProductLink)
                ...
                alert(
                  'El enlace a la tienda no está disponible para este perfume.'
                );
            }}
          >
            AÑADIR A LA CESTA
  ...
  // Listado inicial
  const displayedPerfumes = showMore
    ? perfumes.slice(0, 6)
    : perfumes.slice(0, 3);
  ...
  return (
    ...
    >
      ...
      <div className="zara-title-container" style={{ marginBottom: 50 }}>
        <h2 className="zara-title" style={{ fontSize: '2rem' }}>
          TU SELECCIÓN
        </h2>
        <p
